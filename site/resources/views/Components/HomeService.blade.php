    ...
    <div class="row">
        ...
        <div class="col-md-3 p-2 ">
            <div class="card service-card text-center w-100">
                <div class="card-body">
                    <img class="service-card-logo " src="{{$list->img_path}}" alt="Card image cap">
                    <h5 class="service-card-title mt-3">{{$list->title}}</h5>
                    <h6 class="service-card-subTitle p-0 m-0">{{$list->short_desc}}</h6>
                </div>
            </div>
        </div>
        @endforeach
