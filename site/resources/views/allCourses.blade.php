        ...
        <div class="col-md-4 p-1 text-center">
            <div class="card">
                <div class="text-center">
                    ...
                    <h6 class="service-card-subTitle p-0 ">{{$allcourses->	course_des}} </h6>
                    <h6 class="service-card-subTitle p-0 ">{{$allcourses->		course_fee}}  {{$allcourses->	course_totalclass}} </h6>
                    <a href={{url('')}} class="normal-btn-outline mt-2 mb-4 btn">শুরু করুন </a>
                </div>
            </div>
        </div>
    @endforeach    
